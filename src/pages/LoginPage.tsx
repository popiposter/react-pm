      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-[1560px] flex-col justify-center px-4 py-6 sm:py-8 lg:px-8 2xl:max-w-[1760px] 2xl:px-10">
        <div className="grid gap-5 xl:grid-cols-[minmax(620px,0.98fr)_minmax(360px,0.82fr)] xl:items-start xl:gap-8 2xl:grid-cols-[minmax(700px,1fr)_minmax(420px,0.8fr)] 2xl:gap-10">
          <section className="app-surface-strong p-5 sm:p-7 xl:p-8 2xl:p-10">
                ...
                <p className="mt-2 text-sm text-[var(--app-fg)]">
                  {showDemoDefaults ? (
                    <>
                      ...
                      <span className="ml-2 inline-flex rounded-md border border-[var(--panel-border)] bg-[var(--panel-bg-strong)] px-2.5 py-1 text-xs text-[var(--accent)]">
            ...
            {reasonContent && (
              <div className="mt-6 border border-amber-300/20 bg-amber-400/10 p-4 text-[var(--warning-text)]">
                <div className="flex items-start gap-3">
                  <div className="bg-[var(--panel-bg-strong)] p-2 text-[var(--warning-text)]">
            ...
            <form className="mt-6 max-w-xl space-y-5 2xl:max-w-2xl" onSubmit={handleSubmit}>
              <label className="block space-y-2">
                ...
                <Input
                  ...
                  className="h-12 bg-[var(--panel-muted)]"
          ...
          <section className="app-surface p-5 sm:p-7 xl:sticky xl:top-10 xl:p-8 2xl:p-9">
            <div className="space-y-4">
              ...
              <div className="grid gap-3 2xl:gap-4">
                ...
                {showDemoRouteLink && (
                  <div className="border border-[var(--panel-border)] bg-[var(--panel-muted)] p-4 text-sm leading-6 text-[var(--text-muted)]">
